...
struct Checks_t
{
    ...
    */
     ...
     *  In case no objects are passed in the json, we compare all the objects found containing the interface and property above
     */
    ...
    public:
        ...
        /** @brief Perform the check to Match All of the property values under the interface*/
        bool performCheckMatchAll();

        /** @brief Perform the check to Match Any of the property values under the interface*/
